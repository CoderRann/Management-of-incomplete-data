...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#addBtn").click(function () {
			...
			$.ajax({
				url : "workbench/Happy_A/getUserList.do",
				type : "get",
				dataType : "json",
	...
	function pageList(pageNo,pageSize) {
		...
		$.ajax({
			url: "workbench/Happy_A/pageList.do",
				data: {
					"pageNo": pageNo,
					"pageSize": pageSize,
	...
	<div>
		<div style="position: relative; left: 10px; top: -10px;">
			<div class="page-header">
				<h3>Table happy_A</h3>
				<h4>Source:https://github.com/COINtoolbox/photoz_catalogues/blob/master/Happy/happy_A</h4>
			</div>
		</div>
	</div>
